...
const de = {
  ...
  graphml_err_invalid_xml: 'Keine gültige GraphML-/XML-Datei.',
  graphml_err_no_graph: 'Die Datei enthält kein <graph>-Element.',
  graphml_err_empty: 'Die Datei enthält keinen Graphen.',
  graphml_err_unknown_node: 'Eine Kante verweist auf einen unbekannten Knoten.',
...
const en: Record<MsgKey, string> = {
  ...
  editor_export: 'Export',
  editor_import: 'Import',
  graphml_err_invalid_xml: 'Not a valid GraphML/XML file.',
  graphml_err_no_graph: 'The file has no <graph> element.',
  graphml_err_empty: 'The file contains no graph.',
  graphml_err_unknown_node: 'An edge references an unknown node.',
...
const el: Record<MsgKey, string> = {
  ...
  editor_export: 'Εξαγωγή',
  editor_import: 'Εισαγωγή',
  graphml_err_invalid_xml: 'Μη έγκυρο αρχείο GraphML/XML.',
  graphml_err_no_graph: 'Το αρχείο δεν έχει στοιχείο <graph>.',
  graphml_err_empty: 'Το αρχείο δεν περιέχει γράφημα.',
  graphml_err_unknown_node: 'Μια ακμή αναφέρεται σε άγνωστο κόμβο.',
